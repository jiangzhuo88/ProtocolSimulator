...
void ProtocolEditDialog::setupUi()
{
    ...
    // 帧头参数
    auto hdrGroup = new QGroupBox("帧头参数 (勾选'匹配'列启用字段匹配)");
    ...
    // 数据区参数
    auto dataGroup = new QGroupBox("数据区参数");
    ...
    // 回复帧头参数
    auto rplHdrGroup = new QGroupBox("回复帧头参数 (支持随机值)");
    auto rplHdrLayout = new QVBoxLayout(rplHdrGroup);
    ...
    // 回复数据区参数
    auto rplDataGroup = new QGroupBox("回复数据区参数 (支持随机值)");
    auto rplDataLayout = new QVBoxLayout(rplDataGroup);
    ...
    // ====== 帧预览 ======
    auto previewGroup = new QGroupBox("帧预览");
